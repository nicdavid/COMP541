...
module register_file #(
   parameter Nloc = 32,
   parameter Dbits = 32,
   parameter initfile = "E:/Vivado/Projects/ProjectA/ProjectA.srcs/sources_1/new/rfmem.mem"
)(
   input wire clock,
   ...
   assign ReadData1 = (ReadAddr1 != 0) ? rf[ReadAddr1] : 32'b0;     // First output port
   assign ReadData2 = (ReadAddr2 != 0) ? rf[ReadAddr2] : 32'b0;     // Second output port
